...
function AddDoctor() {
  ...
  const {data: services, isLoading} = useQuery('services', () => fetch('https://doctors-100.herokuapp.com/service').then(res=> res.json()));
  ...
  const onSubmit = async data =>{
    ...
    .then(result =>{ 
          if(result.success){
             ...
             fetch('https://doctors-100.herokuapp.com/doctor', {
                              method: "POST",
                              headers: {
